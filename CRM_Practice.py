...
# Create database
# my_cursor.execute("CREATE DATABASE jonbosss")
...
def search_customers():
    ...
    def edit_now(id, index):
        ...
        last_name_label = Label(search_customers, text="Last Name").grid(
            row=index+2, column=0, padx=10, sticky=W)
        address1_label = Label(search_customers, text="Address 1").grid(
            row=index+3, column=0, padx=10, sticky=W)
        address2_label = Label(search_customers, text="Address 2").grid(
            row=index+4, column=0, padx=10, sticky=W)
        city_label = Label(search_customers, text="City").grid(
            row=index+5, column=0, padx=10, sticky=W)
        state_label = Label(search_customers, text="State").grid(
            row=index+6, column=0, padx=10, sticky=W)
        zipcode_label = Label(search_customers, text="Zipcode").grid(
            row=index+7, column=0, padx=10, sticky=W)
        country_label = Label(search_customers, text="Country").grid(
            row=index+8, column=0, padx=10, sticky=W)
        phone_label = Label(search_customers, text="Phone Number").grid(
    ...
    def search_now():
        ...
        if not result:
            ...
            for index, x in enumerate(result):
                ...
                edit_button = Button(
                    search_customers, text="Edit ", command=lambda: edit_now(id_reference, index))
...
search_customers_button = Button(
    root, text="Search / Edit Customers", command=search_customers)
